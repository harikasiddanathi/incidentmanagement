  ...
  //  console.log(data[i].priority);
    prilist.push(data[i].priority);
      ...
      $scope.editincident = function (priority,description,component,name) {
        $http.put('https:/apiid.execute-api.us-east-1.amazonaws.com/dev/im/' + uid, {"description": description, "priority": priority,"name": name,"component": component}, {headers: {'Content-Type': 'application/json'}} 
